\subsection{Register to PowerEnJoy}
%
\textbf{Actors:}
Guest\\
%
...
\item PowerEnJoy sends the data about the part of map requested like location of available cars, location of charging areas and boundary of safe areas. %\Denis :displays al posto di send
...
\subsection{Select money saving option}
%
\textbf{Actors:}
Client \\
%
